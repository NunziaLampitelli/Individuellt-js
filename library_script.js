	...
	try {
		...
		if (response.ok) {
			...
			return data.items.map((item) => ({
				...
				thumbnail:
					item.volumeInfo.imageLinks?.thumbnail || "Thumbnail: unavailable",
				publishedDate:
					item.volumeInfo.publishedDate || "Publishing date: unavailable",
...
function displayResults(results) {
    ...
    // this is to creat for every book a div element in the results
...
function displayReadBooks() {
	...
	// this is to clean the container
